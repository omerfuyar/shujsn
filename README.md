# Shujsn
Shujsn (SHU JSoN) is a portable, cross platform JSON file parser library.
...
Goal is to easily parse a .json file with a user friendly interface. See examples to learn how to use.